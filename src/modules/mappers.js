...
export const toCategoriesRequestJSON = ({ apiIdList, dateFrom, dateTo }) => JSON.stringify({
    client_id: CLIENT_ID, api_id_list: apiIdList, date_from: dateFrom, date_to: dateTo });
export const toBrandsRequestJSON = ({ apiIdList, categoryNameList, dateFrom, dateTo }) => JSON.stringify({
    client_id: CLIENT_ID, api_id_list: apiIdList, category_name_list: categoryNameList, date_from: dateFrom, date_to: dateTo });
export const toProductsRequestJSON = ({ apiIdList, categoryNameList, brandNameList, dateFrom, dateTo }) => JSON.stringify({
    client_id: CLIENT_ID, api_id_list: apiIdList, category_name_list: categoryNameList, brand_name_list: brandNameList, date_from: dateFrom, date_to: dateTo });

export const apiIdListResponseMapper = apiIdListResponse => apiIdListResponse.map(apiId => apiId.id);
